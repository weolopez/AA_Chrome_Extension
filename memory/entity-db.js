...
// import { openDB } from 'https://cdn.jsdelivr.net/npm/idb@8/+esm'; // CDN import replaced
import { openDB } from '../js/idb.js'; // Assuming idb.js is placed in js/

// import { pipeline } from "https://cdn.jsdelivr.net/npm/@xenova/transformers"; // CDN import replaced
// import { env } from "https://cdn.jsdelivr.net/npm/@xenova/transformers"; // CDN import replaced
import { pipeline, env } from '../js/transformers.js'; // Assuming transformers.js is placed in js/

// Specify a custom location for models (defaults to '/models/').
// Specify a custom location for models relative to the worker script
env.localModelPath = "../memory/huggingface";

// Disable the loading of remote models from the Hugging Face Hub:
// env.allowRemoteModels = false;

// Set location of .wasm files. Defaults to use a CDN.
// Set location of .wasm files relative to the worker script.
env.backends.onnx.wasm.wasmPaths = '../memory/';
// Disable multi-threading in workers (nested workers not allowed)
